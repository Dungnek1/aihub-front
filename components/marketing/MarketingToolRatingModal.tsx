...
import { rateMarketingTool } from "@/services/client/tools.client";
import { Tool } from "@/types/tool.types";

interface MarketingToolRatingModalProps {
    open: boolean;
    onClose: () => void;
    start: number;
    tool: Tool;
...
export default function MarketingToolRatingModal({
    open,
    onClose,
    tool,
    start,
    ...
    const handleRate = async () => {
        ...
        try {
            const response = await rateMarketingTool(tool.id, selectedRating);
