...
export default function Footer({ locale, texts }: FooterProps) {
  return (
    <footer className="relative z-20 w-full bg-transparent mt-auto text-white">
      <div className="px-4 sm:px-8 w-full pt-6 pb-6">
        ...
        <div className="flex flex-col sm:flex-row items-start justify-between gap-8 mb-8">
          ...
          <div className="flex flex-col items-center sm:items-start justify-between self-stretch w-full sm:w-[360px] gap-6">
            ...
            {/* Description */}
            <p className="font-normal text-base leading-6 text-[#d5d7da] text-center sm:text-left">
              {texts.description}
            </p>

            {/* Community Section */}
            <div className="flex flex-col gap-3 items-center sm:items-start">
              <p className="font-normal text-base leading-6 text-[#d5d7da]">
                {texts.joinCommunity || "Join our community"}
              </p>
              {/* Social Icons */}
              <div className="flex items-start justify-center sm:justify-start gap-5 w-full">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/30 hover:text-white/50 transition-colors opacity-50 blur-[0.5px]"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/30 hover:text-white/50 transition-colors opacity-10"
          ...
          <div className="flex sm:hidden flex-col items-center gap-6 w-full">
            ...
            <Link
              href={`/${locale}/terms`}
              className="font-normal text-base leading-6 text-[#d5d7da] hover:text-white transition-colors"
            >
            ...
            <div className="flex flex-col items-center gap-4">
              <h3 className="font-normal text-xl leading-[30px] text-white">
                {texts.company}
              </h3>
          ...
          <div className="hidden sm:flex items-start gap-[72px] sm:w-auto lg:w-[533px]">
            ...
            <div className="flex flex-col gap-3">
              <h3 className="font-normal text-xl leading-[30px] text-white w-[128px]">
                {texts.explore}
              </h3>
              <div className="flex flex-col gap-4">
                <Link
                  href={`/${locale}/blog`}
                  className="font-normal text-base leading-6 text-[#d5d7da] hover:text-white transition-colors w-[128px]"
                >
                  {texts.latestNews}
                </Link>
                <Link
            ...
            <div className="hidden lg:flex flex-col gap-3">
              <h3 className="font-normal text-xl leading-[30px] text-white w-full">
                {texts.resources}
              </h3>
              <div className="flex flex-col gap-4">
                <Link
            ...
            {/* Company */}
            <div className="hidden lg:flex flex-col gap-3">
              <h3 className="font-normal text-xl leading-[30px] text-white w-[90px]">
                {texts.company}
              </h3>
              <div className="flex flex-col gap-4">
                <Link
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Legal Links */}
          <div className="hidden sm:flex font-normal gap-[25px] items-center leading-6 text-[#d5d7da] text-base">
            <Link
              href={`/${locale}/terms`}
